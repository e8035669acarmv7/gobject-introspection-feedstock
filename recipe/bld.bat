...
%BUILD_PREFIX%\Scripts\meson.exe --buildtype=release --prefix=%LIBRARY_PREFIX_M% --wrap-mode=nofallback --backend=ninja -Dcairo=enabled -Dcairo_libname=cairo-gobject.dll -Dpython=%PYTHON_M% ..
